package com.i.and.you.global.jwt;
...
public class TokenProvider {
    ...
    public String generateToken(com.i.and.you.domain.user.entity.User user, Duration expiredAt) {
        Date now = new Date();
     ...
     * JWT 토큰 생성 메서드
     */
    private String makeToken(Date expiry, com.i.and.you.domain.user.entity.User user) {
        Date now = new Date();
